...
export const QuickWebsiteLaunch: React.FC<Props> = ({ profile, setProfile, onExploreTemplates, onOpenDashboard, showToast }) => {
  ...
  return <main className="min-h-dvh bg-slate-50 px-4 pb-12 pt-24 text-slate-900"><section className="mx-auto max-w-3xl rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-8">
