...
export const CATEGORY_TEMPLATES: Record<string, CategoryTemplateConfig> = {
  ...
  hair_salon: {
    ...
    about: 'Welcome to our studio. We bring together master precision haircuts, bespoke balayage, sculpted gel nail art, and restorative hair spa therapies in a modern luxury sanctuary.',
    icon: 'content_cut',
