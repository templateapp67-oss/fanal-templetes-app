...
// Define default demo salon profile for mock mode
const demoPresetSalon = {
  profile: {
    ownerId: null,
...
// Seed demo salons
mockSalons['demo'] = demoPresetSalon;
mockSalons['arts-by-uma'] = demoPresetSalon;
mockSalons['artsbyuma'] = demoPresetSalon;
mockSalons['mirakistudio'] = {
  ...demoPresetSalon,
  profile: {
    ...demoPresetSalon.profile,
